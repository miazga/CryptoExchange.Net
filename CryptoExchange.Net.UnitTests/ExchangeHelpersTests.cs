...
public class ExchangeHelpersTests
{
    ...
    {
        decimal result = ExchangeHelpers.ClampValue(min, max, input);
    ...
    public void AdjustValueStepTests(decimal min, decimal max, decimal? step, RoundingType roundingType, decimal input,
        decimal expected)
    {
        decimal result = ExchangeHelpers.AdjustValueStep(min, max, step, roundingType, input);
        Assert.AreEqual(expected, result);
    }
    ...
    public void AdjustValuePrecisionTests(decimal min, decimal max, int? precision, RoundingType roundingType,
        decimal input, decimal expected)
    {
        decimal result = ExchangeHelpers.AdjustValuePrecision(min, max, precision, roundingType, input);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        decimal result = ExchangeHelpers.RoundDown(input, decimalPlaces);
        Assert.AreEqual(expected, result);
    }
    ...
    {
        decimal result = input.Normalize();

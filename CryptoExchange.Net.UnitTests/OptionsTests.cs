...
public class OptionsTests
{
    ...
    public void TestBasicOptionsAreSet()
    {
        ...
        {
            ApiCredentials = new ApiCredentials("123", "456"), ReceiveWindow = TimeSpan.FromSeconds(10)
        };
    ...
    public void TestApiOptionsAreSet()
    {
        ...
        TestClientOptions options = new TestClientOptions
        {
            Api1Options =
                ...
                {
                    ApiCredentials = new ApiCredentials("123", "456"), BaseAddress = "http://test1.com"
                },
            Api2Options = new RestApiClientOptions
            {
                ApiCredentials = new ApiCredentials("789", "101"), BaseAddress = "http://test2.com"
            }
        };
    ...
    public void TestNotOverridenApiOptionsAreStillDefault()
    {
        ...
        TestClientOptions options = new TestClientOptions
        {
            Api1Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("123", "456") }
        };
    ...
    public void TestSettingDefaultBaseOptionsAreRespected()
    {
        ...
        TestClientOptions.Default = new TestClientOptions
        {
            ApiCredentials = new ApiCredentials("123", "456"), LogLevel = LogLevel.Trace
        };
    ...
    public void TestSettingDefaultApiOptionsAreRespected()
    {
        ...
        TestClientOptions.Default = new TestClientOptions
        {
            ...
            Api1Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("456", "789") }
        };
    ...
    public void TestSettingDefaultApiOptionsWithSomeOverriddenAreRespected()
    {
        ...
        TestClientOptions.Default = new TestClientOptions
        {
            ...
            LogLevel = LogLevel.Trace,
            Api1Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("456", "789") },
            Api2Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("111", "222") }
        };

        // act
        TestClientOptions options = new TestClientOptions
        {
            Api1Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("333", "444") }
        };
    ...
    public void TestClientUsesCorrectOptions()
    {
        ...
        {
            ApiCredentials = new ApiCredentials("123", "456"),
            Api1Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("111", "222") }
        });
    ...
    public void TestClientUsesCorrectOptionsWithOverridingDefault()
    {
        ...
        {
            Api1Options = new RestApiClientOptions { ApiCredentials = new ApiCredentials("333", "444") },
            Api2Options = new RestApiClientOptions { BaseAddress = "http://test.com" }
        });
...
{
    private RestApiClientOptions _api1Options = new("https://api1.test.com/");

    private RestApiClientOptions _api2Options = new("https://api2.test.com/");
    ...
    /// </summary>
    public static TestClientOptions Default { get; set; } = new();
